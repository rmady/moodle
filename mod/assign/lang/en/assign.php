...
$string['usercantremovesubmission'] = 'User do not have the capabilities to remove submission from this user assignment';
$string['userdonthavesubmission'] = 'User do not have submission in this assignment';
