...
$string['invalidselfunenrol'] = 'Invalid request to self unenrol from course';
$string['invalidunenrolrequest'] = 'Invalid request to unenrol another user from course, you do not have permission!';
$string['invalidunenrol'] = 'Invalid request to unenrol user from course';
